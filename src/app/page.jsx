    ...
    <div className="min-h-screen bg-background">
      ...
      <main>
        ...
        <section className="bg-muted">
          <div className="container mx-auto">
            ...
            <div className="flex flex-col md:flex-row">
              <div className="w-full md:w-1/2 relative p-2 md:p-10 py-2 flex items-center">
                <Image
              ...
              <div className="w-full md:w-1/2 p-4 md:p-8 flex flex-col justify-center">
                ...
                <p className="text-base text-muted-foreground mb-6">
                  Protagonist Blueprint also includes( Academic Weapon + Content brain )
                  <br />
        ...
        <section id="templates" className="py-12 bg-muted">
          <div className="container mx-auto px-4">
            <h2 className="text-3xl font-bold text-center mb-8">Our Templates</h2>
            <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
              {['Project Management', 'Personal Dashboard', 'Content Calendar'].map((template) => (
                <Card key={template}>
                  <CardHeader>
                  ...
                  <CardContent>
                    ...
                    <p className="text-sm text-muted-foreground mb-4">
                      Boost your productivity with our {template.toLowerCase()} template.
                    </p>
        ...
        <section id="reviews" className="py-12">
          <div className="container mx-auto px-4">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
              {[
                { name: 'Alex', comment: 'These templates have revolutionized my workflow!' },
                { name: 'Sam', comment: 'I\'ve never been more organized. Highly recommend!' },
                { name: 'Jordan', comment: 'The best investment I\'ve made for my productivity.' }
              ].map((review, index) => (
                <Card key={index}>
